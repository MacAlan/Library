...
public class Utility extends Application {
	...
	public static void showMainWindow1() throws Exception {
		utility.start("/mainLib/mainBoard.fxml", "mainLib/mainBoard.css", 1200, 700);
	}
	public static void showMainWindowAdmin() throws Exception {
		utility.start("/mainAdmin/mainBoard.fxml", "mainAdmin/mainBoard.css", 1200, 700);
	}
