...
public class AddBooksController {
    ...
    private void addMember(ActionEvent event) {
        ...
        if(fName.isEmpty()||lName.isEmpty()||str.isEmpty()||cit.isEmpty()||st.isEmpty()||zp.isEmpty()||phoneN.isEmpty() || UserIn.getText().equals("")|| passwordIn.getText().equals("")) {
    ...
    @FXML
    private void showMain(ActionEvent event) throws Exception {
